...
exports.signup = (req,res) => {
    ...
    let insertUserQuery = "INSERT INTO users (nom, prenom, age, filiere, typeParcours, email, mdp ) VALUES (?,?,?,?,?,?,?)"
    ...
    .then((hash) => {
        dataBase.query(
            insertUserQuery,
            [req.body.name, req.body.surname, req.body.age, req.body.filiere, req.body.typeParcours, req.body.email, hash],
            (error, result)=>{
                if (error) {
